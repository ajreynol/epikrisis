...
to doing the work. It is kept, and the two documents below the line are what it
costs to be a repository rather than a directory — neither displaced anything and
both say so.

**[`presidency.md`](presidency.md) was the first to displace none of them**, and
...
| document | what it is for |
| --- | --- |
| [`presidency.md`](presidency.md) | What the ecosystem's president is bound to ask here, what is answerable, and the two things that are not. |
